...
const facilitySearch = document.querySelector('.facility-search')
const facilitySearchInput = document.querySelector('.facility-search').querySelector('input')

facilitySearchInput.addEventListener('focus', () => {
  facilitySearch.querySelector('i').style.display = 'none';
});

facilitySearchInput.addEventListener('blur', () => {
  if (!facilitySearchInput.value.trim()) {
    facilitySearch.querySelector('i').style.display = 'block';
  }
});
